...
@app.route("/")
def index():
    reponse = requests.get(f"{ADRESSE_NOEUD_CONNECTE}/info_chaine")
    ...
    if reponse.status_code == 200:
        ...
        contexte = {
            "titre": "Réseau décentralisé, pour partager du contenu",
...
def envoyer_demande_enregistrement():
    requests.post(
        f"{ADRESSE_NOEUD_CONNECTE}/senregistrer_aupres",
